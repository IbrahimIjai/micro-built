            ...
            <PopoverTrigger asChild>
              <div className="relative">
                <Button variant="secondary" className="rounded-full relative">
                  ...
                  {notificationCount > 0 && (
                    <Badge
                      className="absolute bg-green-500 rounded-full -top-2 -right-2 h-5 w-5 flex items-center justify-center p-0 text-xs"
                    >
            ...
            <PopoverContent className="w-80 p-0 bg-background" align="end">
              <div className="p-4 border-b bg-muted/50">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-medium text-muted-foreground">Notifications</h3>
                </div>
              </div>
