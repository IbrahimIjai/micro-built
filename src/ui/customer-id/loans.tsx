    ...
    <Card className="w-full bg-background py-0 gap-0">
      ...
      <CardContent className="space-y-4 mb-3">
        {paginatedLoans.map(({ date, category, amount, id }) => (
          <div
            key={id}
            className="flex flex-col gap-3 p-3 border rounded-[6px] border-[#F0F0F0]"
          >
            ...
            <h4 className="font-semibold text-[#666666] text-sm mt-5">
              {category}
            </h4>
            <div className="flex items-center gap-2 justify-between">
              <p className="text-lg font-semibold text-[#8A0806]">
