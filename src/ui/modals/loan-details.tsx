      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid gap-2">
          ...
          <Detail
            ...
            content={`${formatCurrency(loan.amount * (loan.interestRate / 100))} (${loan.interestRate}%)`}
          />
          <Detail
            ...
            <div className="flex flex-col gap-2">
              {data?.data && (
                <p className="text-xs text-[#666666] leading-relaxed">
                  ...
                  <strong>{formatCurrency(data.data.amount)}</strong>{" "}
                </p>
              )}
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-[#999999] text-xs font-normal">
                  New Active loan tenure: {(data?.data?.tenure ?? 0) + (loan.tenure || 0)} months
                </span>
              </div>
            </div>
          </>
